...
function tonav() {
  ...
  document.getElementById("page-name").innerText = document.title.split(" | 自强3！2！1！")[0];
}
...
function createtime() {
  ...
  (currentTimeHtml =
    hnum < 18 && hnum >= 9
      ? `<div style="font-size:13px;font-weight:bold">我们的家已经一起走过 ${dnum} 天 ${hnum} 小时 ${mnum} 分 ${snum} 秒 <i id="heartbeat" class='fas fa-heartbeat'></i></div>`
      : `<div style="font-size:13px;font-weight:bold">我们的家已经一起走过 ${dnum} 天 ${hnum} 小时 ${mnum} 分 ${snum} 秒 <i id="heartbeat" class='fas fa-heartbeat'></i></div>`),
...
if (localStorage.getItem("blogbg") != undefined) {
  ...
  document.getElementById("defineBg").innerText = `:root{
    --default-bg: url(https://potatojiang.oss-cn-chengdu.aliyuncs.com/family/2025.11.23%E7%A4%BE%E5%BA%86.jpg);
    --darkmode-bg:url(https://potatojiang.oss-cn-chengdu.aliyuncs.com/family/2025.11.23%E7%A4%BE%E5%BA%86.jpg);
    --mobileday-bg: url(https://potatojiang.oss-cn-chengdu.aliyuncs.com/family/2025.11.23%E7%A4%BE%E5%BA%86.jpg);
    --mobilenight-bg: url(https://potatojiang.oss-cn-chengdu.aliyuncs.com/family/2025.11.23%E7%A4%BE%E5%BA%86.jpg);
  }`;
}
// 切换背景主函数
function changeBg(s) {
...
<h3>1. 家园风景</h3>
<details class="folding-tag" cyan><summary> 查看家园风景背景 </summary>
              <div class='content'>
              <div class="bgbox"><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://images.unsplash.com/photo-1469474968028-56623f02e42e?auto=format&fit=crop&w=1200&q=80)" class="imgbox" onclick="changeBg('url(https://images.unsplash.com/photo-1469474968028-56623f02e42e?auto=format&fit=crop&w=1200&q=80)')"></a></div>
              </div>
            </details>
...
<details class="folding-tag" cyan><summary> 查看活动剪影背景 </summary>
              <div class='content'>
              <div class="bgbox"><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://images.unsplash.com/photo-1521737604893-d14cc237f11d?auto=format&fit=crop&w=1200&q=80)" class="imgbox" onclick="changeBg('url(https://images.unsplash.com/photo-1521737604893-d14cc237f11d?auto=format&fit=crop&w=1200&q=80)')"></a></div>
              </div>
            </details>

<h3>3. 温暖一刻</h3>

<details class="folding-tag" cyan><summary> 查看温暖一刻背景 </summary>
              <div class='content'>
              <div class="bgbox"><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://images.unsplash.com/photo-1524504388940-b1c1722653e1?auto=format&fit=crop&w=1200&q=80)" class="imgbox" onclick="changeBg('url(https://images.unsplash.com/photo-1524504388940-b1c1722653e1?auto=format&fit=crop&w=1200&q=80)')"></a></div>
              </div>
            </details>
...
<details class="folding-tag" cyan><summary> 查看手机壁纸 </summary>
              <div class='content'>
              <div class="bgbox"><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://images.unsplash.com/photo-1500648767791-00dcc994a43e?auto=format&fit=crop&w=1200&q=80)" class="pimgbox" onclick="changeBg('url(https://images.unsplash.com/photo-1500648767791-00dcc994a43e?auto=format&fit=crop&w=1200&q=80)')"></a></div>
              </div>
            </details>
...
<details class="folding-tag" cyan><summary> 设置自定义背景 </summary>
              <div class='content'>
              <p><center><input type="text" id="pic-link" size="70%" maxlength="1000" placeholder="请输入有效的图片链接，如 https://images.unsplash.com/..."></center></p><p><center><button type="button" onclick="getPicture()" style="background:var(--theme-color);width:35%;padding: 5px 0px 7px 0px;border-radius:30px;color:white;line-height:2;">🌈切换背景🌈</button></center></p>
              </div>
            </details>
